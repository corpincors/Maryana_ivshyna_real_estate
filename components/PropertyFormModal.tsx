...
import { 
  ...
  INITIAL_DISTRICTS, HOUSE_TYPES_EXTENDED, LOCATION_TYPES
} from '../constants.tsx';
      ...
      <div className="bg-white w-full max-w-5xl max-h-[95vh] rounded-[3rem] overflow-y-auto relative custom-scrollbar animate-in zoom-in-95 duration-300">
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-12">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {isHouses && ( // Поле для расположения
              <div className="space-y-2">
          ...
          <section className="space-y-10">
            ...
            {isHouses && formData.locationType === 'outsideCity' && ( // Поле для расстояния от города
